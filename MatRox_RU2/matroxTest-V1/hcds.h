...
{
	cds.nearoffset = (unsigned long int *) mkl_malloc(sizeof(unsigned long int)*tree.ncount, 64);
	memset(cds.nearoffset, 0, sizeof(unsigned long int)*tree.ncount);
...
{
	cds.faroffset = (unsigned long int *) mkl_malloc(sizeof(unsigned long int)*tree.fcount, 64);
	memset(cds.faroffset, 0, sizeof(unsigned long int)*tree.fcount);
