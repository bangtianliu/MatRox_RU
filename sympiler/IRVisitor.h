...
public:
    ...
    virtual void visit(const Foru *op);
	virtual void visit(const ForG *op);
	virtual void visit(const DeclVariable *op);
	virtual void visit(const ForTree *op);
	...
	virtual void visit(const CallMKL *op);
