...
```bash
python3 drawscal.py --m [path/to/scal.csv] --g [path/to/goscal.csv] --s[path/to/stscal.csv] --sa[path/to/smascal.csv]
```
...
```bash
python3 drawscalknl.py --m [path/to/scal.csv] --g [path/to/goscal.csv] --s[path/to/stscal.csv]
```
...
use "python3 drawscal.py -h" to check the useage
